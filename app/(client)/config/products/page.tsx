...
export default function ProductsPage() {
  ...
  // Filtered categories untuk dropdown search
                      ...
                      data.map((item, idx) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            ...
                            <div className="text-xs font-semibold text-emerald-600 bg-emerald-100 inline-block px-2 py-0.5 rounded mt-1">
                              {item.code}
                            </div>
                          </td>
                          <td className="px-6 py-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder="e.g. Kredit Multiguna Premium"

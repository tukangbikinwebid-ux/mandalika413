...
interface ProductCategoryModalProps {
  isOpen: boolean;
  onClose: () => void;
  onUpdateTotal: (total: number) => void; // Callback update jumlah di dashboard
}
...
export default function ProductCategoryModal({
  ...
  const [paginate] = useState(5); // Limit per page
  ...
  }, [isOpen, page, search]); // Refetch saat param berubah
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl w-full max-w-4xl shadow-2xl border-2 border-orange-200 overflow-hidden flex flex-col max-h-[90vh]">
        {/* Header */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      // Update: bg-gray-100, border-none, ring focus

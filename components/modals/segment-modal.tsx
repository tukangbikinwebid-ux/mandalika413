...
export default function SegmentModal({
  ...
  const [products, setProducts] = useState<Product[]>([]); // Data untuk Dropdown
  ...
  // --- State Custom Dropdown Searchable (Product) ---
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl w-full max-w-5xl shadow-2xl border-2 border-orange-200 overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="px-8 py-6 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-orange-50 to-white">
          <div>
            <h2 className="text-2xl font-black text-gray-900">Segments</h2>
            <p className="text-sm text-gray-500 font-medium mt-1">
              Manage risk segments parameters (PD/LGD)
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-8 overflow-y-auto flex-1 bg-white">
          {view === "list" ? (
                          ...
                          >
                            ...
                            <td className="px-6 py-4">
                              <div className="flex flex-col gap-1">
                                <span className="text-xs font-bold bg-blue-100 text-blue-700 px-2 py-0.5 rounded w-fit">
                                  PD: {item.pd}%
                                </span>
                                <span className="text-xs font-bold bg-red-100 text-red-700 px-2 py-0.5 rounded w-fit">
                                  LGD: {item.lgd}%
                                </span>
                              </div>
                            </td>
            ...
            /* --- Form View (Borderless, Full Width) --- */
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <input
                      ...
                      placeholder="e.g. Segment A - High Risk"
